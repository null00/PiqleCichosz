...
public class TwoPlayerReferee {
	 ...
	 */
	public int episode() {
		IEnvironmentTwoPlayers ie = (IEnvironmentTwoPlayers) this.j1
				.getCurrentState().getEnvironment();
		...
		// who won ?
		if (verbosity) {
			if (situation.getWinner() == -1)
				System.out.println("J1 won\n");
			if (situation.getWinner() == 1)
				System.out.println("J2 won\n");
			if (situation.getWinner() == 0)
